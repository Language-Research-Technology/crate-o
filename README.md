...
-  Describo data packs / name authorities.
...
The Language Data Commons of Australia project is committed to developing Crate-O and [RO-Crate Excel] to allow community members to generate their own annotations of existing GLAM collections.
